...
{
    public class UpdateEducationalInstitutionLocationCommandValidator : AbstractValidator<UpdateEducationalInstitutionLocationCommand>
    {
        public UpdateEducationalInstitutionLocationCommandValidator()
        {
