...
namespace EducationalInstitutionAPI.Business.Queries_Handlers
{
    public class GetAllAdminsByEducationalInstitutionIDQueryHandler : HandlerBase<GetAllAdminsByEducationalInstitutionIDQueryHandler>,
                                                                      IRequestHandler<DTOAdminsByEducationalInstitutionIDQuery, Response<GetAllAdminsOfEducationalInstitutionQueryResult>>
    {
        ...
        public async Task<Response<GetAllAdminsOfEducationalInstitutionQueryResult>> Handle(DTOAdminsByEducationalInstitutionIDQuery request, CancellationToken cancellationToken = default)
        {
